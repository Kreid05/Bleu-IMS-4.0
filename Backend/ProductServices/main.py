...
app.add_middleware(
    ...
    allow_origins=[
        ...
        "http://192.168.100.10:3000", # ims frontend
        "http://127.0.0.1:4000", # ims auth
        "http://localhost:4000",
        "http://localhost:9001", # pos
        "http://127.0.0.1:9001", # pos
        "http://localhost:8001", # ims products
        "http://127.0.0.1:8001",  # ims products
    ],
